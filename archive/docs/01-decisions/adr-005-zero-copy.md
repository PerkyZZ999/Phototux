...
- **Allowed by ADR-015:** One-shot CPU decode/GPU upload on explicit Open and one-shot GPU readback/CPU encode on explicit Export. These are file-operation boundaries, not the interactive present path.
...
| 2026-07-15 | Explicit Open/Export one-shot transfer boundary (ADR-015) | Phase 5 raster I/O |
