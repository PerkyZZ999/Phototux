...
- Layer styles still have **no editor**: they can be added from the menu and take their defaults, and no control changes a colour, offset or radius. That was already true of the four that shipped; it is now true of eight. Tracked as the next slice.
