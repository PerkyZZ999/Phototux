...
pub const ALL: &[CommandMeta] = &[
    ...
    view_ephemeral(command_id::VIEW_ZOOM_IN),
    view_ephemeral(command_id::VIEW_ZOOM_OUT),
    view_ephemeral(command_id::VIEW_ZOOM_ACTUAL),
    ...
    doc_tx(command_id::SMART_CREATE),
    doc_tx(command_id::SMART_SET_PLACEMENT),
    doc_tx(command_id::SMART_RASTERIZE),
