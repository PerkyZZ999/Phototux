...
pub use document_gpu::{
    ...
    selection_apply_ellipse, selection_apply_polygon, selection_apply_rect, selection_clear,
    selection_color_select, selection_invert, selection_restore, selection_select_all,
    selection_snapshot, snapshot_document_layers, stamp_dabs, sync_and_composite, undo_stroke,
    write_layer_rgba, write_mask_r8,
};
